...
// 6 - Standard bottom row for OS
 [MAC_BASE] = LAYOUT_ansi_82(
        TD_ESC,                           KC_BRID, KC_BRIU, KC_MCTRL, KC_LNPAD, KC_F5, KC_F6, KC_MPRV, KC_MPLY, KC_MNXT, KC_F10,  KC_F11,   KC_F12,              MT(MOD_LSFT | MOD_LCTL, KC_DEL),  KC_MUTE,
        KC_GRV,                           KC_1,    KC_2,    KC_3,     KC_4,     KC_5,  KC_6,  KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,  KC_EQL,              KC_BSPC, KC_INS,
        KC_TAB,                           KC_Q,    KC_W,    KC_E,     KC_R,     KC_T,  KC_Y,  KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC,  KC_RBRC,             KC_BSLS, KC_PGUP,
        MT(MOD_LSFT | MOD_LCTL, KC_CAPS), KC_A,    KC_S,    KC_D,     KC_F,     KC_G,  KC_H,  KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,                       KC_ENT,  KC_PGDN,
